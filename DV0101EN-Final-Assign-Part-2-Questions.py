...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unem_eff= recession_data.groupby(['Vehicle_Type'])['Unemployment_Rate', 'Automobile_Sales'].mean().reset_index() 
        R_chart4 =dcc.Graph(
           figure=px.bar(unem_eff, 
                x='Vehicle_Type',
                y='Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(ymas, x=ymas.index, y=ymas.values,title='Total Monthly Automobile sales in the year {}'.format(input_year)))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(average_sales, 
